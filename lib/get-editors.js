...
var clientCode = function (parsedJson) {
    ...
    _.each(cells, function(cell) {
      ...
      if (!_.isNull(cell.editor)) {
        item.items = [convertEditor(cell.editor)];
        item.style = _.omit(item.style, ["border-top-style", "border-left-style", "border-right-style", "border-bottom-style", "border-color", "border-width"]);
      }
